...
_logout = () => {
  ...
  <View>
	...
	<View style={[styles.wrapper, {borderColor: '#ddd', borderBottomWidth: 1, height: 50}]}>
              ...
              <TouchableOpacity style={[{ width: width *.5, left: width *.25, zIndex: 10,alignItems:'center'}]} >
                ...
                style={[styles.brand, {width:110,height:32,marginBottom: 5, marginTop: 10}]}
                        source={require('./images/img_logo.png')}
                      />
                </TouchableOpacity>
            
             <TouchableOpacity style={[styles.carticon, {top: 15}]}  onPress={() =>this.props.navigation.navigate('Search')}>
              <Image  
             ...
             <Text style={{fontSize: 11,color: '#c5c5c5', width: width, textAlign: 'center', marginTop: 35}}>
			 DAMDA People
			 </Text>
			 <Text style={{fontSize: 21,color: '#000', width: width, textAlign: 'center', marginTop: 5, fontWeight: 'normal' }}>
			 담다 피플
			 </Text>
			 ...
			 지금 담다에서 가장 핫한 브랜드
					 ...
					 
				{
									...
									<View style={{position: 'absolute', top: -5, left: 58}}>
                                                 <Text style={[styles.ctext, {fontSize: 16,fontWeight: 'normal', color:'#000'}]}>{name}</Text>
        ...
        <View style={styles.item_section}>
			  ...
			  <TouchableOpacity style={[styles.item_header]} onPress={this._phone}>
                ...
                style={{width:22,height:20,}}
                      ...
                      />  
					  <Text style={{color: '#ff5500', marginLeft: 5}}>﻿고객센터</Text>
			  </TouchableOpacity>
                ...
                style={{width:20,height:20,}}
                      ...
                      />  
					  <Text style={{color: '#ff5500', marginLeft: 5}}>﻿자주 찾는 질문</Text>
			  </TouchableOpacity>
			  ...
			  <TouchableOpacity style={[styles.item_header, {borderRightWidth: 0}]} onPress={() => this.props.navigation.navigate('Notice')}>
                ...
                style={{width:22,height:20,}}
                      ...
                      />  
					  <Text style={{color: '#ff5500', marginLeft: 5}}>﻿공지사항</Text>
			  </TouchableOpacity>
