...
class EditAddress extends React.Component {
    ...
    this.state = {
		...
		id: this.props.navigation.state.params.id_, 
		webViewHeight: 0,
		address: (this.props.user_login) ? this.props.user_login.user.addresses : [],
		addressInfo: this.props.user_login.user.addresses[this.props.navigation.state.params.id_],
  ...
  componentDidMount() {
	  this.setState({
		vn_: (this.state.addressInfo.telephone.split('-').length > 1) ? this.state.addressInfo.telephone.split('-')[0] : '',
		phone_: (this.state.addressInfo.telephone.split('-').length > 1) ? this.state.addressInfo.telephone.split('-')[1] : this.state.addressInfo.telephone.split('-')[0],
		name: this.state.addressInfo.firstname + ' ' +this.state.addressInfo.lastname,
		postcode: this.state.addressInfo.postcode,
		street: this.state.addressInfo.street[0],
		default_billing: (typeof this.state.addressInfo.default_billing) ? this.state.addressInfo.default_billing : false,
		default_shipping: (typeof this.state.addressInfo.default_shipping) ? this.state.addressInfo.default_shipping : false,
	})
  ...
  _login = () => {
		...
		addressInfo.street[0] = this.state.street
		...
		customer.addresses[this.state.id] = addressInfo
